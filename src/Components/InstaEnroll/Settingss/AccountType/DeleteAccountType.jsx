...
const DeleteAccount = () => {
  ...
  const handleDeleteClick = () => {
    ...
    handleDelete(payload, userId, selectedAccount, "/body/accounttype/:id");
  };
  ...
  return (
    <div className="p-5 w-[78] h-[43rem] overflow-y-auto scrollbar scrollbar-thumb-scrollbar-color-gray scrollbar-thumb-rounded-full scrollbar-w-2">
      ...
      <div className="mb-4 flex flex-col">
        <label
          htmlFor="feedback"
          className="flex text-sm font-medium text-color-black items-start py-1"
        >
