...
const DeleteProofOfAddress = () => {
  ...
  const handleDeleteClick = () => {
    ...
    handleDelete(payload, userId, selectedAddressProof, "/body/proofofaddress/:id");
  };
  ...
  return (
    <div className="p-5 w-[78] h-[43rem] overflow-y-auto scrollbar scrollbar-thumb-scrollbar-color-gray scrollbar-thumb-rounded-full scrollbar-w-2 font-roboto">
      ...
      {/* Buttons */}
      <div className="mb-4  left-auto right-0 flex justify-end gap-2 px-4 ">
        <button
...
export default DeleteProofOfAddress;
