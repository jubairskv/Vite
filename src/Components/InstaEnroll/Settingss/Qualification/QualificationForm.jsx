...
const QualificationForm = ({
  ...
  useEffect(() => {
    if (selectedQualification) {
      setQualificationName(selectedQualification.qualification_name);
      setDescription(selectedQualification.description);
    } else {
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...
      id: selectedQualification?.id, // Only pass id if editing
    };
  ...
  return (
    <div className="mt-4 ml-4 min-h-[80vh] mr-4 flex flex-col items-start">
      <h1 className="text-2xl font-bold text-gray-800 flex">
        {selectedQualification ? "Edit Qualification" : "Create Qualification"}
      </h1>
      <form
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-8 justify-stretch">
          <div className="flex flex-col items-start w-full lg:w-96">
            ...
            <input
              ...
              onChange={(e) =>
                setQualificationName(e.target.value.toUpperCase())
              }
              ...
              placeholder={t("qualification_placeholder_text")}
              required
              autoComplete="off"
            />
          </div>
        ...
        {/* Add dynamic error/success messages if needed here */}
