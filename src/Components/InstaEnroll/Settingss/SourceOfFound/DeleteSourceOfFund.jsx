...
import {
  SOURCE_OF_FUND_DELETE,
  SOURCE_OF_FUND_DELETE_AUTH,
} from "../../../../Utils/Constant";
...
const DeleteSourceOfFund = () => {
  ...
  const handleDeleteClick = () => {
    const payload = {
      id: selectedSourceOfFund.id,
      del_narration: feedback,
    };

    handleDelete(payload, userId, selectedSourceOfFund, "/body/sourceoffund/:id");
  };

  if (!selectedSourceOfFund) {
    return <div>No Source Of fund data available for deletion.</div>;
  }
  ...
  return (
    <div className="p-5 w-[78] h-[43rem] overflow-y-auto scrollbar scrollbar-thumb-scrollbar-color-gray scrollbar-thumb-rounded-full scrollbar-w-2 font-roboto">
      ...
      <div className="mb-4">
        ...
        >
          Why are you deleting this Source of fund?
        </label>
        <textarea
          id="feedback"
          rows="4"
...
export default DeleteSourceOfFund;
