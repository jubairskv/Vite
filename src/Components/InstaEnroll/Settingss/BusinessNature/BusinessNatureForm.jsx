...
const BusinessNatureForm = ({ selectedBusiness, onSubmit, isSubmitting }) => {
  ...
  return (
    <div className="mt-4 ml-4 min-h-[80vh] mr-4 flex flex-col items-start">
      <h1 className="text-2xl font-bold text-gray-800 flex">
        {selectedBusiness ? "Edit Business Nature" : "Create Business Nature"}
      </h1>
      <form
        onSubmit={handleSubmit}
        className="relative w-full pt-10 bg-white rounded-lg space-y-8 mt-5 min-h-[80vh]"
        noValidate
      >
        {/* Business Name Input */}
        <div className="flex flex-col sm:flex-row gap-8 w-full justify-stretch">
          <div className="flex flex-col items-start w-full lg:w-96">
            ...
            <input
              ...
              placeholder={t("business_placeholder_text")}
              required
              autoComplete="off"
            />
          </div>
