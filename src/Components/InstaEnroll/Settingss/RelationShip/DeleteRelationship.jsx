...
const DeleteRelationship = () => {
  ...
  const handleDeleteClick = () => {
    ...
    handleDelete(payload, userId, selectedRelationship, "/body/relationship/:id");
  };

  if (!selectedRelationship) {
    return <div>No Relationship data available for deletion.</div>;
  }
  ...
  return (
    <div className="p-5 w-[78] h-[43rem] overflow-y-auto scrollbar scrollbar-thumb-scrollbar-color-gray scrollbar-thumb-rounded-full scrollbar-w-2 font-roboto">
      ...
      <div className="mb-4">
        ...
        >
          Why are you deleting this Relationship?
        </label>
        <textarea
          id="feedback"
          rows="4"
